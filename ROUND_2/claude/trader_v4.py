# trader.py — IMC Prosperity 4, Round 2 (Final Log‑Proven Micro‑Optimizations)
import json
import math
...
class Trader:
    ...
    # --- Pepper (8,678 baseline – unchanged) ---
    PEPPER_SLOPE = 0.001
    PEPPER_BUY_TOL = 4
    ...
    # --- Osmium (8,678 baseline + two proven changes) ---
    ...
    OSM_AGGRESSIVE_SELL_THRESH = 10_002   # ← Lowered from 10_003 (recovers 11 missed sells)
    OSM_SELL_COOLDOWN = 0                  # ← Removed (was 300, unnecessary)

    # Smart features disabled (proven harmful)
    ...
    def _osmium_orders(self, state: TradingState, data: dict) -> List[Order]:
        ...
        # Aggressive selling (threshold lowered, cooldown removed)
