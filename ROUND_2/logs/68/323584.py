# trader.py - IMC Prosperity 4, Round 2 (315520 Frozen Control)
#
...
class Trader:
    ...
    # --- Osmium (315520 control) ---
    OSM_FAIR_FALLBACK = 10_000
    OSM_EMA_ALPHA = 0.02
    OSM_PASSIVE_BID_OFFSET = 6
    ...
    # Optional "smart" features. Disabled by default so the control remains
    # identical to the archived 315520 submission.
