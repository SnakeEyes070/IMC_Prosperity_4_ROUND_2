# trader.py — IMC Prosperity 4, Round 2 (Asymmetric Lite)
# 8,200 baseline + asymmetric L1 offsets to exploit –0.50 autocorrelation.
...
class Trader:
    ...
    # ──────────────────────────────────────────────────────────────────
    # OSMIUM – Asymmetric L1 (buy deeper, sell tighter)
    # ──────────────────────────────────────────────────────────────────
    def _osmium_orders(self, state: TradingState, data: dict) -> List[Order]:
        ...
        # Dynamic offsets (symmetric base)
        ...
        # Asymmetric adjustment: L1 buys deeper, sells tighter
