# trader.py — IMC Prosperity 4, Round 2 (Precision‑Enhanced from 8,200 Baseline)
# Upgrades: Micro‑price fair value, larger L1 size, relaxed imbalance filter.
...
class Trader:
    ...
    OSM_EMA_ALPHA     = 0.015
    OSM_L1_SIZE       = 22        # increased from 18
    OSM_L2_SIZE       = 16        # increased from 14
    OSM_L3_SIZE       = 12        # increased from 10
    OSM_MR_THRESH     = 7         # slightly tighter (more reversion)
    OSM_MR_MAX_QTY    = 26        # increased from 24
    OSM_SKEW_FACTOR   = 0.06
    OSM_IMBALANCE_THRESH = 0.35  # relaxed filter
    ...
    # ──────────────────────────────────────────────────────────────────
    def bid(self) -> int:
        return 6000   # increased to confidently clear median
    ...
    # ──────────────────────────────────────────────────────────────────
    # PEPPER – Unchanged from 8,200 baseline
    # ──────────────────────────────────────────────────────────────────
