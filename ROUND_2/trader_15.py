# trader.py — IMC Prosperity 4, Round 2 (Precision‑Optimized for 9k+)
# Safe upgrades: larger passive sizes, slightly faster EMA, earlier unwind.
...
class Trader:
    ...
    # ── PEPPER (micro‑tuned) ───────────────────────────────────────────
    PEPPER_SLOPE   = 0.001
    PEPPER_BUY_TOL = 16           # slightly wider
    PEPPER_MAX_BUY = 80

    # ── OSMIUM (scaled sizes, faster EMA) ──────────────────────────────
    OSM_FAIR_FALLBACK = 10_000
    OSM_EMA_ALPHA     = 0.020     # faster adaptation
    OSM_L1_SIZE       = 20        # increased from 18
    OSM_L2_SIZE       = 16        # increased from 14
    OSM_L3_SIZE       = 12        # increased from 10
    OSM_MR_THRESH     = 8         # unchanged (proven)
    OSM_MR_MAX_QTY    = 28        # increased from 24
    OSM_SKEW_FACTOR   = 0.06

    # ── TIMING ─────────────────────────────────────────────────────────
    ROUND_DAYS     = 3
    MAX_TS         = 99_900
    ENDGAME_START  = 96_000       # slightly earlier unwind
    NEW_DAY_THRESH = 10_000

    # ──────────────────────────────────────────────────────────────────
    def bid(self) -> int:
        return 7000   # higher MAF bid to guarantee extra flow
    ...
    # ──────────────────────────────────────────────────────────────────
    # PEPPER – Unchanged core, slightly wider tolerance
    # ──────────────────────────────────────────────────────────────────
    ...
    # ──────────────────────────────────────────────────────────────────
    # OSMIUM – Faster EMA, larger sizes
    # ──────────────────────────────────────────────────────────────────
