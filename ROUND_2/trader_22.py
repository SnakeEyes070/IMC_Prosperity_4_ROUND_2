# trader.py — IMC Prosperity 4, Round 2 (Final Micro‑Calibration)
# Unwind at 94,500; Osmium L1 size 19.
...
class Trader:
    ...
    # ── PEPPER (final calibration) ────────────────────────────────────
    PEPPER_SLOPE   = 0.001
    PEPPER_BUY_TOL = 15
    ENDGAME_START  = 94_500       # slightly earlier

    # ── OSMIUM (tiny size increase) ───────────────────────────────────
    OSM_FAIR_FALLBACK = 10_000
    OSM_EMA_ALPHA     = 0.015
    OSM_L1_SIZE       = 19          # +1 from 18
    OSM_L2_SIZE       = 14
    OSM_L3_SIZE       = 10
    OSM_MR_THRESH     = 8
    OSM_MR_MAX_QTY    = 24
