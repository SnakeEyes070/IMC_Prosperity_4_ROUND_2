# trader.py — IMC Prosperity 4, Round 2 (Full Aggression)
# Maxed passive sizes, larger mean reversion, wider Pepper tolerance.
...
class Trader:
    ...
    # ── PEPPER (aggressive) ───────────────────────────────────────────
    PEPPER_SLOPE   = 0.001
    PEPPER_BUY_TOL = 20           # wider: guarantee instant fill
    ENDGAME_START  = 94_500

    # ── OSMIUM (maxed sizes) ──────────────────────────────────────────
    OSM_FAIR_FALLBACK = 10_000
    OSM_EMA_ALPHA     = 0.015
    OSM_L1_SIZE       = 25        # maxed
    OSM_L2_SIZE       = 18
    OSM_L3_SIZE       = 12
    OSM_MR_THRESH     = 8
    OSM_MR_MAX_QTY    = 30        # larger captures
