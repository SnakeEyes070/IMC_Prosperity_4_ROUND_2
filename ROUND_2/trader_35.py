...
class Trader:
    ...
    PEPPER_SLOPE   = 0.001
    PEPPER_BUY_TOL = 12          # Reduced from 15 (log shows fills at 13007-13008)
    ENDGAME_START  = 94_000      # Earlier: volume drops to 5 by 97,400
    ...
    OSM_AGGRESSIVE_BUY_THRESH  = 9_996   # Buy if ask <= this
    OSM_AGGRESSIVE_SELL_THRESH = 10_004  # Sell if bid >= this
