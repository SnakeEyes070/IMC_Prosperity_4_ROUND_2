# trader.py — IMC Prosperity 4, Round 2 (Final Aggressive Push)
# 8,434 baseline + larger scalp + tighter Osmium thresholds.
...
class Trader:
    ...
    OSM_AGGRESSIVE_BUY_THRESH  = 9_997   # Tightened by 1
    OSM_AGGRESSIVE_SELL_THRESH = 10_003  # Tightened by 1
    ...
    def _osmium_orders(self, state: TradingState, data: dict) -> List[Order]:
        ...
        # Aggressive taking (tightened thresholds)
        ...
        # Original mean reversion (safety net)
