# trader.py — IMC Prosperity 4, Round 2 (Final Maximum Profit)
# Combines: asymmetric lite + scalp + passive bid fallback + calibrated thresholds
...
class Trader:
    ...
    PEPPER_SLOPE = 0.001
    PEPPER_BUY_TOL = 8                # Optimal from backtester sweep
    ENDGAME_START = 94_000            # Smooth exit before volume dries up

    # --- Osmium (asymmetric lite + proven thresholds) ---
    ...
    def bid(self) -> int:
        return 6_500                     # Confidently above median MAF
                ...
                for ask_px in sorted(od.sell_orders.keys()):
                    ...
                    if ask_px <= fair + self.PEPPER_BUY_TOL:
                        ...
                        if vol > 0:
                            ...
                            buy_cap -= vol
                # ✅ FIX: Passive bid instead of unconditional market buy
                if buy_cap > 0 and od.sell_orders:
