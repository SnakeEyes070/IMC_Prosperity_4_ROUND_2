# trader.py — 8,636 Baseline + Pepper Optimizations (Backtest Version)
import json
import math
...
class Trader:
    ...
    # --- Pepper (8,636 + optimizations) ---
    PEPPER_SLOPE = 0.001
    PEPPER_BUY_TOL = 6                # ← Tighter (was 8)
    ENDGAME_START = 90_000            # ← Earlier (was 92,000)
    SCALP_RESERVE = 6                 # ← NEW: Keep 6 units free for scalps

    SCALP_DIP = 8
    SCALP_EXIT = 5
    SCALP_SIZE = 10

    # --- Osmium (8,636 baseline, unchanged) ---
