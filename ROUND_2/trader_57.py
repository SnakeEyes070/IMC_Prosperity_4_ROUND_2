# trader.py — 8,636 Baseline + Osmium Optimizations (Backtest Version)
import json
import math
...
class Trader:
    ...
    # --- Pepper (8,636 baseline, unchanged) ---
    PEPPER_SLOPE = 0.001
    PEPPER_BUY_TOL = 8
    ...
    # NEW: Inventory skew
    OSM_SKEW_PER_UNIT = 0.1           # ← Shift quotes by 0.1 ticks per unit of position
