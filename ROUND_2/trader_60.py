# trader.py — IMC Prosperity 4, Round 2 (Data‑Driven Recalibration)
import json
import math
...
class Trader:
    ...
    OSM_AGGRESSIVE_SELL_THRESH = 10_002   # ← only this changed from 8,643
